                    ...
                    <div class="pt-4 border-t border-gray-200 mt-6 flex flex-col-reverse sm:flex-row justify-between items-center gap-3 sm:gap-0">
                        ...
                        <div class="w-full sm:w-auto flex flex-col sm:flex-row gap-3">
                            <div style="width: 100%;">
                                ...
                                <button 
                                    ...
                                    style="
                                        ...
                                        background-color:rgb(184, 161, 243);
                            ...
                            <button 
                                ...
                                x-show="currentStep === 3"
                                @click="submitForm()"
                                class="w-full inline-flex justify-center items-center px-6 py-3 border border-transparent shadow-sm text-base font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors duration-150"
                                ...
                                <span x-text="isSubmitting ? 'Menyimpan...' : 'Simpan Kosan'"></span>
                            </button>
                        </div>
                    </div>
                </div>
